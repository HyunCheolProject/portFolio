                    ...
                    <table>
                        ...
                        <c:forEach items="${memberList}" var="member">
                            <tr>
                                ...
                                <td><strong>${member.memberAge}</strong></td>
                                <td><strong>${member.memberEmail}</strong></td>
                                <td><strong>${member.memberMobile}</strong></td>
                                <td><strong><a href="/member/detail?id=${member.id}">조회</a></strong></td>
                                <td><strong><a href="/member/delete?id=${member.id}">삭제</a></strong></td>
                            </tr>
                        </c:forEach>
                    </table>
